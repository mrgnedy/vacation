...
class _ContactUsPageState extends State<ContactUsPage> {
  ...
  TextEditingController _textFieldControllerEmail;

  @override
  void initState() {
    _scopedModelDrawerPages = ScopedModelDrawerPages();
    _textFieldControllerEmail = TextEditingController();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return ScopedModel<ScopedModelDrawerPages>(
      ...
      child: Scaffold(
        body: Stack(
          children: <Widget>[
            ScopedModelDescendant(builder: (BuildContext context, Widget child,
                ScopedModelDrawerPages model) {
              return Stack(
                children: <Widget>[
                  ListView(
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: RaisedButton(
                            onPressed: () {
                              if (_textFieldControllerEmail.text.toString() ==
                                      null ||
                                ...
                                Utility.shawAlertDialogFailed(
                                    context: context,
                                    title: "الاداره",
                                    msg: "من فضلك اكتب رسالتك");
                              } else {
                                _scopedModelDrawerPages.setContactMessage(
                                    context: context,
                                    msg: _textFieldControllerEmail.toString());
                              }
                            },
