...
class SkipOffers extends StatefulWidget {
  @override
  _SkipOffersState createState() => _SkipOffersState();
}

class _SkipOffersState extends State<SkipOffers> {





  ScopedModelSkipePage get _scopedModelSkipe => GetIt.I<ScopedModelSkipePage>();

  @override
  void initState()
  {
    _scopedModelSkipe.initialStreamSkipOffers();
    _scopedModelSkipe.stopLoadingHomePage();
    _scopedModelSkipe.getAllOffersSkip(context: context);
    _scopedModelSkipe.outAllOffersSkip.listen((onData)
    {
                                        ...
                                        return InkWell(
                                          onTap: () {
                                            Navigator.push(context,
                                                SlideRightRoute(page: SkipShowChalet(chaletId: snapshot.data.data[index].id,)));
                                          },
                                          child: Padding(
                                            padding:
