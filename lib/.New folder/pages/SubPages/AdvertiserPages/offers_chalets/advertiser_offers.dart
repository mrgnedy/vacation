...
class _AdvertiserOffersState extends State<AdvertiserOffers> with AutomaticKeepAliveClientMixin {
                                        ...
                                        return InkWell(
                                          onTap: () {
                                            Navigator.push(context,
                                                SlideRightRoute(page: ShowOffers(chaletId: snapshot.data.data[index].id,)));
                                          },
                                          child: Padding(
                                            padding:
