...
class _PreviousReservationsState extends State<PreviousReservations> {
  ...
  void initState()
  {
    ...
    _modelReservations.getAllReservationsPrevious(context: context);
                        ...
                        case ConnectionState.waiting:
                          if (ScopedModelMainPageUser.checkExistOffers)
                            ...
                            return Center(child: Text(
                              "لا يوجد حجوزات سابقه", style: TextStyle(
                                fontSize: 25.0,
                                            ...
                                            return  InkWell(
                                              onTap: ()
                                              {
                                                Navigator.push(context,
                                                    SlideRightRoute(page: CancelReservation(flag1Cancel: false,flag2Rating: true,flag3Report: true,chaletName: snapshot.data.data[index].name,endtDate: snapshot.data.data[index].startDate,
