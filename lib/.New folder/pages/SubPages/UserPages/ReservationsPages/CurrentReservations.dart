                                            ...
                                            return  InkWell(
                                                onTap: ()
                                                {
                                                  ...
                                                  Navigator.push(context,
                                                        SlideRightRoute(page: CancelReservation(flag1Cancel: true,flag2Rating: true,flag3Report: true,chaletName: snapshot.data.data[index].name,endtDate: snapshot.data.data[index].startDate,
