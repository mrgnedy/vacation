            ...
            onPressed: () {
              ...
              if (_textFieldAddDescountOfOffers.text.toString().isEmpty ||
                ...
                _scopedModelShow.addChaletToOffers(
                    ...
                    chaletId: chaletId,
                    discount: int.parse(
                        _textFieldAddDescountOfOffers.text.toString()));
                  ...
                  onTap: () {
                    showDialog(
                        ...
                        builder: (context) => Dialog(
                            ...
                            backgroundColor: Colors.transparent,
                            child:
                                // items: List.generate(widget.imgList.length, (i){
                                //   return Image.network(widget.imgList[i],fit: BoxFit.cover,);
                                // }),
                                // initialPage: index,
                                // autoPlay: false,
