...
import 'package:vacatiion/model/ShowSkipModel.dart';
...
class _SkipShowChaletState extends State<SkipShowChalet> {
  ...
  void initState()
  {
    ...
    _scopedModelShowChalet.initialStreamControllerShowChaletSkip();
    _scopedModelShowChalet.getDataForChaletSkipe(context: context, chaletId: widget.chaletId);
    imageList=List<String>();
    _scopedModelShowChalet.outStreamShowChaletSkip.listen((onData)
    {
        ...
        child: Scaffold(
            body: ScopedModelDescendant<ScopedModelShowChalet>(
                builder: (BuildContext context, Widget child,
                  ...
                  return StreamBuilder<ShowChaletSkip>(
                      stream: model.outStreamShowChaletSkip,
