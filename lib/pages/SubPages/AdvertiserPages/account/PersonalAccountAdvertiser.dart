...
//                                     ),  // sets initials text, set your own style, default Text('')
                                          ...
                                          Container(
                                            ...
                                            child: Padding(
                                              padding: const EdgeInsets.all(8.0),
                                              child: Text("${snapshot.data.data.bank==null? 'لم يدخل بعد':snapshot.data.data.bank }",style: TextStyle(fontSize: 18,color: ColorsV.defaultColor),),
                                            ),
                                          ),
                                          //phone
                                          ...
                                          Container(
                                            ...
                                            child: Padding(
                                              padding: const EdgeInsets.all(8.0),
                                              child: Text("${snapshot.data.data.accountName=='null'? 'لم يدخل بعد':snapshot.data.data.accountName }",style: TextStyle(fontSize: 18,color: ColorsV.defaultColor),),
                                            ),
                                          ),
                                          //phone
                                          ...
                                          Container(
                                            ...
                                            child: Padding(
                                              padding: const EdgeInsets.all(8.0),
                                              child: Text("${snapshot.data.data.accountNumber=='null'? 'لم يدخل بعد': snapshot.data.data.accountNumber}",style: TextStyle(fontSize: 18,color: ColorsV.defaultColor),),
                                            ),
                                          ),
                                          //phone
                                          ...
                                          Container(
                                            ...
                                            child: Padding(
                                              padding: const EdgeInsets.all(8.0),
                                              child: Text("${snapshot.data.data.eban=='null'? 'لم يدخل بعد': snapshot.data.data.eban}",style: TextStyle(fontSize: 18,color: ColorsV.defaultColor),),
                                            ),
                                          ),
                                          //Iban
                                          SizedBox(
