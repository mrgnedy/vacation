...
class ShowOffers extends StatefulWidget {
  ...
  ShowOffers({this.chaletId});

  @override
  _ShowOffersState createState() => _ShowOffersState();
}
                                                ...
                                                child: RaisedButton(
                                                  onPressed: ()
                                                  {
                                                    //shawAlertAddReating(snapshot.data.data.chalet.id.toString(),context,snapshot.data.data.chalet.name);
                                                     _scopedModelShowChalet.removeOffer(chaletId: snapshot.data.data.chalet.id.toString(),context: context);
                                                  },
