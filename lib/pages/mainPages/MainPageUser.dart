...
//                  ),
                  ...
                  CircleAvatar(
                    radius: 25,
                    backgroundColor: onTapColor(0), // button color
                    child: ClipOval(
                      child: Material(
                        color: Colors.transparent,
                        child: InkWell(
  ...
  Color onTapColor(int index) {
    return index == selectedIndex ? Colors.lightBlue[600] : Colors.transparent;
  }
}
                          ...
                          Padding(
                            ...
                            child: Column(
                              children: <Widget>[
                                ...
                                ///---------------Content for TabBar---------------//
                                Container(
                                  height: (ScopedModelMainPageUser
                                              .numbersOfChalets
                                              .toDouble() *
                                          165) +
                                  ...
                                  child: Chip(
                                    ...
                                    label: Padding(
                                      padding: const EdgeInsets.only(
                                          ...
                                          bottom: 8),
                                      child: Text(
                                          'ابحث بأسم المدينه او الموقع الجغرافي'),
                                    ),
...
class _CarouselSliderState extends State<CarouselSlider> {
  ...
  Widget build(BuildContext context) {
    return ScopedModel<ScopedModelBannerUser>(
        model: _bannerUser,
        child: Scaffold(
          body: ScopedModelDescendant<ScopedModelBannerUser>(builder:
              (BuildContext context, Widget child,
                  ScopedModelBannerUser model) {
