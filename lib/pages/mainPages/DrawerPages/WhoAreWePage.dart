...
class WhoAreWePage extends StatefulWidget
{
  ...
  @override
  _WhoAreWePageState createState() => _WhoAreWePageState();
}
    ...
    return  ScopedModel<ScopedModelDrawerPages>(
      ...
      child: Scaffold(
        body:  Stack(
          children: <Widget>[
        FutureBuilder(
        future:  _scopedModelDrawerPages.getAboutUsPage(context: context), //This is the method name above
          builder: (context, AsyncSnapshot<ModelDrawer> snapshot)
          {
